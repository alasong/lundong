...
| 创业板 | 938 只 | 300xxx 代码 |
| 科创板 | 603 只 | 688xxx 代码 |
| 沪主板 | 215 只 | 600/601/603/605 代码 |
| 深主板 | 168 只 | 000/001/002/003 代码 |
| 中证500 | 500 只 | 指数成分股 |
...
python src/main.py --mode stock --start-date 20200101 --end-date 20260315

# 仅采集中证500成分股
python src/main.py --mode stock --stock-type csi500 --start-date 20250101

# 仅采集创业板
python src/main.py --mode stock --stock-type gem --start-date 20250101

# 仅采集科创板
python src/main.py --mode stock --stock-type star --start-date 20250101
...
| `stock` | **个股数据采集** | `--mode stock --stock-type all` | TUSHARE_TOKEN |
